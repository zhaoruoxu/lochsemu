...
DECLARE_INST_HANDLER(Adc_81_ext2);		// ADC r/m16/32, imm16/32
DECLARE_INST_HANDLER(Sbb_81_ext3);       // SBB r/m16/32, imm16/32
...
DECLARE_INST_HANDLER(Ror_D1_ext1);      // ROR r/m32, 1
...
DECLARE_INST_HANDLER(Cmpxchg_0FB0);     // CMPXCHG r/m8, r8
DECLARE_INST_HANDLER(Cmpxchg_0FB1);     // CMPXCHG r/m32, r32
DECLARE_INST_HANDLER(Btr_0FB3);         // BTR r/m16/32, r16/32
...
DECLARE_INST_HANDLER(Bsf_0FBC);         // BSF r16/32, r/m16/32
DECLARE_INST_HANDLER(Bsr_0FBD);         // BSR r16/32, r/m16/32
...
DECLARE_INST_HANDLER(Fpu_Fucomi_DBE8);      // FUCOMI
